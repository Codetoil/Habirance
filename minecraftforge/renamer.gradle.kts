...
dependencies {
	...
	implementation("com.github.glitchfiend:TerraBlender-forge:${commonMod.minecraft_version}-${commonMod.prop("terrablender_version")}")
	...
	if (stonecutter.eval(stonecutter.current.version, "<=1.20.1")) {
		runtimeOnly("squeek.appleskin:appleskin-forge:${commonMod.prop("appleskin_version_forge")}") {
			exclude("modmenu")
		}
	}
