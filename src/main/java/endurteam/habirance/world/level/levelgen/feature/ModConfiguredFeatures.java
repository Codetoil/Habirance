...
import endurteam.habirance.tag.ModTags;
...
import endurteam.habirance.world.level.levelgen.structure.templatesystem.NearBlockTest;
...
public class ModConfiguredFeatures {
    ...
    public static final DeferredRegister<ConfiguredFeature<?,?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registries.CONFIGURED_FEATURE, Habirance.MOD_ID);


    public static final RegistryObject<ConfiguredFeature<?,?>> ALABASTER = CONFIGURED_FEATURES.register("alabaster",
            () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(
                    List.of(
                            OreConfiguration.target(new BlockMatchTest(Blocks.DEEPSLATE_DIAMOND_ORE), ModBlocks.ALABASTER.get().defaultBlockState())
                    ),3)));
